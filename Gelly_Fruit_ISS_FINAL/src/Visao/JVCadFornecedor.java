 ...
 * @author Larissa-PC
 */
public class JVCadFornecedor extends javax.swing.JInternalFrame {
    BuscaFornecedor busca = new BuscaFornecedor(this);
    Fornecedores fornecedor = new Fornecedores();//cria o objeto fornecedor da classefornecedoree
    //cria o objeto cfornecedor da classe Cfornecedor
    ...
    private void btmNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btmNovoActionPerformed
        ...
        if(validaCampos() == true){
            ...
            if (validar == true){
                ...
                cfornecedor.Salvar(Registro);

                JOptionPane.showMessageDialog(null,"fornecedor salvo com sucesso !","Salvar",JOptionPane.INFORMATION_MESSAGE);
                //LimpaCampos();
            }
            else
            {
    ...
    private void btmExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btmExcluirActionPerformed
        //BOTÃO EXCLUIR
        int podeExcluir = JOptionPane.showConfirmDialog(rootPane,"Tem certeza que deseja excluir o fornecedor?","Meu Programa",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);

        if(podeExcluir == 0 ){
            CFornecedor cfornecedor = new CFornecedor();
            cfornecedor.Excluir(Integer.parseInt(txtcodigo.getText()));
    ...
    private void btmAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btmAlterarActionPerformed
        ...
        if(validaCampos() == true){
            ...
            if (validar == true){
                ...
                CFornecedor cfornecedor = new CFornecedor();
                cfornecedor.Alterar(Registro);

                JOptionPane.showMessageDialog(null,"Fornecedor alterado com sucesso !","Alterar",JOptionPane.INFORMATION_MESSAGE);
                LimpaCampos();
            }
            else
            {
    ...
    public void PreencheCampos(int codigo) {
        ...
        cli = CFornecedor.BuscaCadastro(codigo);
        
        Fornecedores objFornecedoresBuffer;     
        objFornecedoresBuffer = cli.get(0);
        
        txtcodigo.setText(String.valueOf(objFornecedoresBuffer.getId_Fornecedor()));
        txtnome.setText(objFornecedoresBuffer.getNome());
        cbmStatus.setSelectedIndex(objFornecedoresBuffer.getStatus());
        txtRG.setText(objFornecedoresBuffer.getRg());
        txtCPF.setText(objFornecedoresBuffer.getCpf());
        txtEnd.setText(objFornecedoresBuffer.getRua());
        txtBairro.setText(objFornecedoresBuffer.getBairro());
        txtComp.setText(objFornecedoresBuffer.getComplemento());
        txtCEP.setText(objFornecedoresBuffer.getCep());
        txtMunicipio.setText(objFornecedoresBuffer.getCidade());
        txtEstado.setText(objFornecedoresBuffer.getEstado());
        txtPais.setText(objFornecedoresBuffer.getPais());
        txtTel.setText(objFornecedoresBuffer.getTelefone());
        txtCel.setText(objFornecedoresBuffer.getCelular());
        txtEmail.setText(objFornecedoresBuffer.getEmail());        
